...
/opt/vault/bin/run-vault --tls-cert-file "$VAULT_TLS_CERT_FILE" --tls-key-file "$VAULT_TLS_KEY_FILE" --enable-auto-unseal --auto-unseal-kms-key-id "${auto_unseal_kms_key_id}" --auto-unseal-kms-key-region "${aws_region}"
